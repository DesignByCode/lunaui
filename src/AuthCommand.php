...
class AuthCommand extends Command
{
    ...
    protected $views = [
        ...
        'partials/_nav.stub' => 'partials/_nav.blade.php',
        'partials/_footer.stub' => 'partials/_footer.blade.php',
        'partials/_status.stub' => 'partials/_status.blade.php',
    ];
    ...
    protected function ensureDirectoriesExist()
    {
        ...
        if (! is_dir($directory = $this->getViewPath('partials'))) {
            mkdir($directory, 0755, true);
        }
